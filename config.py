...
TRAIN_LR = 0.001  # 学习率
TRAIN_LR_SCHEDULER_FACTOR = 0.8  # 学习率衰减因子
...
WORD_EMBEDDING_PTH_FILENAME = f"./pt/word_embedding_{MODEL_TYPE}_{MODEL_HIDDEN_SIZE}_{MODEL_DROPOUT_PROBS}_{MODEL_ACTIVATION}_{SEQUENCE_LENGTH}_{WORD2VEC_VECTOR_SIZE}_{WORD2VEC_EPOCHS}_{WORD2VEC_MIN_COUNT}_{TRAIN_BATCH_SIZE}_{TRAIN_EPOCHS}_{TRAIN_LR}_{TRAIN_LR_SCHEDULER_FACTOR}.pt"  # 词向量保存路径
